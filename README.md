...
### 1.1 목표
- 시간이 없는 **청년**들에게 체질 확인 및 교육 기회 확대 플랫폼
- 나이 드신 **어르신**들에게도 쉽게 체질 확인할 수 있는 플랫폼
- 확인한 체질을 이용하여 식단 관리 및 스트레스 관리하는 건강 플랫폼
- 여러 한의원 및 보건 의사와 **협업** 가능

### 1.2 기능
- **체질별 관리 시스템** 제공
- 누구나 자유롭게 **피드백** 가능
- 다양하고 자유롭게 **공유**할 수 있는 플랫폼
- 타 플랫폼에서도 활용할 수 있는 API Set 제공
- 각 언어별 로그인 없이 검사할 수 있는 환경
